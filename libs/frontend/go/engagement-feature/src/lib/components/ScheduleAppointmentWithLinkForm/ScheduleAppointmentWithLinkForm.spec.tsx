...
import ScheduleAppointmentWithLinkForm from './ScheduleAppointmentWithLinkForm';
...
const submitForm = async () =>
  userEvent.click(screen.getByRole('button', { name: /schedule a meeting/i }));
...
describe(
  ...
  () => {
    ...
    beforeEach(() => {
      render(<ScheduleAppointmentWithLinkForm />);
    });
