...
describe('getInitialValue', () => {
  it('should return null if prices is undefined', () => {
    expect(getInitialValue(undefined)).toEqual(null);
  });

  it('should return active price id if prices array is available', () => {
    const priceId = getInitialValue([
      {
    ...
    expect(priceId).toEqual('price_1Mq9D7FabpOjRn7HWILE9Cro');
  });
});
