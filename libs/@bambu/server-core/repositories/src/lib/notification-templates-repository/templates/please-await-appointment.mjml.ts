...
<mjml>
  <mj-head>
    <mj-title>We’ll get back to you soon!</mj-title>
    ...
    <mj-section padding-bottom="0">
      <mj-column>
        ...
        <mj-text font-weight="500" font-size="14px" line-height="20px" letter-spacing="0.1px">Thank you for your interest in scheduling an appointment. We’re eager to help you achieve your goal.</mj-text>
				<mj-text font-weight="500" font-size="14px" line-height="20px" letter-spacing="0.1px">Rest assured, we will be contacting you shortly. Meanwhile, if you'd like to pursue different goals, feel free to revisit <a href=[FE HTTPS link]">our platform</a>.</mj-text>
...
// Warning: This function should not directly interpolate strings. It should either use string input to select a template, or parr them through a function that essentially sanitizes it.
export function GeneratePleaseAwaitAppointmentTemplate({
  logoUrl,
  brandColor,
  agentName,
  tradeName,
