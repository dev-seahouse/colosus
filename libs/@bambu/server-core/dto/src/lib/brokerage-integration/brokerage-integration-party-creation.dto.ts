...
import { BrokerageIntegrationPartyIdentifierCreationDto } from './brokerage-integration-party-identifier.dto';
import {
...
export class BrokerageIntegrationPartyCreationDto
  implements IBrokerageIntegrationPartyCreationDto
{
  ...
  @ApiProperty({
    ...
    type: () => BrokerageIntegrationPartyIdentifierCreationDto,
  })
  @ValidateNested({ each: true })
  @Type(() => BrokerageIntegrationPartyIdentifierCreationDto)
  identifiers: BrokerageIntegrationPartyIdentifierCreationDto[];
