...
- `npx storybook@latest automigrate --config-dir apps/go/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir apps/go-advisor/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir libs/frontend/react-ui/.storybook --renderer @storybook/react`
