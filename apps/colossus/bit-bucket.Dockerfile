...
COPY --chown=colossus:colossus dist/apps/colossus/package.json ./package.json
COPY --chown=colossus:colossus dist/apps/colossus/yarn.lock ./yarn.lock
...
COPY --chown=colossus:colossus dist/apps/colossus ./apps/colossus
...
CMD [ "node", "./apps/colossus/main.js" ]
