...
export class TransactLeadsInputProjectedReturnsDto
...
export class TransactInvestorLeadInputDto
  implements ConnectLeadsDto.IConnectLeadsItemDto
{
  ...
  @ApiProperty({
    type: 'boolean',
    example: true,
    description: 'If the lead is employed.',
    required: true,
  })
  @IsBoolean()
  @IsNotEmpty()
  ...
  @ApiProperty({
    type: TransactLeadsInputProjectedReturnsDto,
  ...
  @ValidateNested()
  @Type(() => TransactLeadsInputProjectedReturnsDto)
  projectedReturns: TransactLeadsInputProjectedReturnsDto;
