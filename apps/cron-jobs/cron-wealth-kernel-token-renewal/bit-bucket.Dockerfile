...
COPY --chown=colossus:colossus dist/apps/cron-jobs/cron-wealth-kernel-token-renewal/package.json ./package.json
COPY --chown=colossus:colossus dist/apps/cron-jobs/cron-wealth-kernel-token-renewal/yarn.lock ./yarn.lock
...
COPY --chown=colossus:colossus dist/apps/cron-jobs/cron-wealth-kernel-token-renewal ./apps/cron-jobs/cron-wealth-kernel-token-renewal
