...
import { WealthKernelTokenRenewalService } from './app/wealth-kernel-token-renewal.service';
...
async function bootstrap() {
  ...
  const cronService = app.get(WealthKernelTokenRenewalService);

  try {
    logger.log('Running CRON instance.');
